...
exports.message = exports.signIn = exports.signUp = void 0;
...
const message = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield user_1.default.findOneAndUpdate({ email: req.body.email }, { message: req.body.message });
    const updateUser = yield user_1.default.findOne({ email: req.body.email });
